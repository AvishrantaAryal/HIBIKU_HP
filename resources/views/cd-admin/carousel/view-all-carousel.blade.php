...
<section class="content" style="padding: 40px;">
  <div class="row">
    <div>
      <a href="{{url('/cd-admin/add-carousel')}}"><button class="btn btn-success" style="margin-bottom: 10px; ">Add Carousel</button></a>
    ...
    <div class="container">
      <div style="height: 85px;">
       <form action="{{url('/cd-admin/updateCarousel/'.$car->id)}}" method="POST" class="pull-left">
        {{csrf_field()}}
        <div class="btn-group">
...
<section class="content" style="padding: 40px;">
  <div class="row">
    <div>
      <a href="{{url('/cd-admin/add-carousel')}}"><button class="btn btn-success" style="margin-bottom: 10px; ">カルーセルを追加</button></a>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-footer">
          ...
          <a href="{{url('/cd-admin/delete-carousel/'.$ser->id)}}"><button type="button" class="btn btn-outline">Yes</button></a>
        </div>
      </div>
      <!-- /.modal-content -->
    </div>
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <div class="modal-footer">
            ...
            <a href="{{url('/cd-admin/delete-carousel/'.$ser->id)}}"><button type="button" class="btn btn-outline">はい</button></a>
          </div>
        </div>
        <!-- /.modal-content -->
      </div>
