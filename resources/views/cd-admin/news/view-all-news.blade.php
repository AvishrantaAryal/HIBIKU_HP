      ...
      <div class="col-xs-12">
       <div class="box">
        <div class="box-header">
          <h3 class="box-title">
           <a href="{{url('/cd-admin/add-news')}}"><button class="btn btn-success" style="margin-bottom: 10px; ">Add News</button></a>
         </h3>
        ...
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{$pa->title}}</td>
              <td height="75px">
               <form action="{{url('/update-news-status/'.$pa->id)}}" method="POST">
                {{csrf_field()}}
                <div class="btn-group">
          ...
          <td>
            <a href="{{url('/cd-admin/edit-news/'.$pa->id)}}"><button class="btn btn-primary"><i class="fa fa-edit"></i></button></a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        @endif
        <strong><h5 >Details In English :</h5></strong><p style="text-align:justify !important;"> {!!$t->description!!}</p>

        <strong><h5>Details In Japanese :</h5></strong><p style="text-align:justify !important;"> {!!$t->description_japanese!!}</p>

        <p style="text-align:justify !important;"> <img src="{{url('uploads/'.$t->image)}}" style="height: 100px; width:100px;"></p>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body">
          <p style="text-align:justify !important;">Are you sure you want to delete ?&hellip;</p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Cancel</button>
          <a href="{{url('cd-admin/delete-news/'.$t->id)}}"> <button type="button" class="btn btn-outline">Yes</button></a>
        </div>
      </div>
      <!-- /.modal-content -->
    </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">ニュース</a></li>
        <li class="active">すべてのニュースを表示</li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
         <div class="box">
          <div class="box-header">
            <h3 class="box-title">
             <a href="{{url('/cd-admin/add-news')}}"><button class="btn btn-success" style="margin-bottom: 10px; ">ニュースを追加</button></a>
           </h3>
           @if(Session::has('success'))
           <div class="alert alert-success alert-dismissible">
            <a class="close" data-dismiss="alert" aria-label="close">&times;</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        @endif
        <strong><h5 >英語の詳細 :</h5></strong><p style="text-align:justify !important;"> {!!$t->description!!}</p>

        <strong><h5>詳細は日本語:</h5></strong><p style="text-align:justify !important;"> {!!$t->description_japanese!!}</p>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body">
          <p style="text-align:justify !important;">本当に削除しますか？&hellip;</p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">番号</button>
          <a href="{{url('cd-admin/delete-news/'.$t->id)}}"> <button type="button" class="btn btn-outline">はい</button></a>
        </div>
      </div>
      <!-- /.modal-content -->
    </div>
