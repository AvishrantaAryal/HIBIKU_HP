    ...
    <div class="row">
      <div class="col-md-12 box1">
        <div class="box box-default">
          ...
          <div class="box-body">
            <form class="form-horizontal" method="post" action= "{{url('cd-admin/insertNews')}}" enctype="multipart/form-data">
              {{csrf_field()}}
              <div class="box-body">

                <div class="form-group">
                  <label for="name" class="col-sm-3 control-label">News Title In English<span style="color: red;">*</span></label>
                ...
                <div class="form-group">
                  <label for="name" class="col-sm-3 control-label">News Title IN Japanese<span style="color: red;">*</span></label>
                ...
                <div class="form-group">
                  <label for="Alternative Image Name" class="col-sm-3 control-label">Image Description<span style="color: red;">*</span></label>
          ...
          <div class="box-body">
            <form class="form-horizontal" method="post" action= "{{url('cd-admin/insertNews')}}" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="name" class="col-sm-3 control-label">英語のニュースタイトル<span style="color: red;">*</span></label>
                  <div class="text text-danger">{{$errors->first('title')}}</div>
                ...
                <div class="form-group">
                  <label for="name" class="col-sm-3 control-label">ニュースタイトル <span style="color: red;">*</span></label>
                  <div class="text text-danger">{{$errors->first('title_japanese')}}</div>
                ...
                <div class="form-group">
                  <label for="Alternative Image Name" class="col-sm-3 control-label"> 画像の説明<span style="color: red;">*</span></label>
                  <div class="text text-danger">{{$errors->first('altimage')}}</div>
...
<div class="box-footer">
 ...
 <button type="submit" class="btn btn-success pull-right">ニュースを追加</button>
</div>
<!-- /.box-footer -->
</form>
<!-- Date dd/mm/yyyy -->
