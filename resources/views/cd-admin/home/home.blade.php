		...
		<div class="row">
			...
			<section class="col-lg-7 connectedSortable">
				...
				<div class="box box-info">
					...
					<div class="alert alert-success">
						<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
						<strong>メッセージが正常に送信されました!!!</strong> {{ Session::get('message', '') }}
					</div>
					@endif
					<div class="box-header">
						<i class="fa fa-envelope"></i>

						<h3 class="box-title">クイックメール</h3>
						<!-- tools box -->
						<div class="pull-right box-tools">
							<button type="button" class="btn btn-info btn-sm" data-widget="remove" data-toggle="tooltip" title="Remove">
								<i class="fa fa-times"></i>
					...
					<div class="box-footer clearfix">
						<button type="submit" class="pull-right btn btn-default" id="sendEmail">送る
							<i class="fa fa-arrow-circle-right"></i>
						</button>
					</div>
					</form>
			...
			<section class="col-lg-5 connectedSortable">
				...
				<div class="box box-info">
					...
					<!-- /.box-body -->
					<div class="box-footer text-center">
						<a href="{{url('view-all-admin')}}" class="uppercase">すべてのユーザーを表示</a>
					</div>
					<!-- /.box-footer -->
				</div>
				<div class="box box-info">
				...
				<div class="box-body">
					...
					<div class="box-footer text-center">
						<a href="{{url('view-all-mails')}}" class="uppercase">すべてのメールを表示</a>
					</div>
